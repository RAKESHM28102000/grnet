...
const Login = () => {
  ...
  return (<section className="flex w-full min-h-screen bg-cover bg-bg1">
    <div className='flex flex-col  justify-center items-center bg-cover bg-bg2 mx-auto shadow-2xl shadow-black hover:shadow-white m-4 rounded-md p-4'>
        <form className="w-[280px] lg:w-[400px] min-h-[300px] flex flex-col gap-2 justify-start items-center">
            ...
            <input type="password"  className="w-[90%] mx-auto text-violet-700  max-md:text-lg md:text-2xl mb-3 focus:ring-inset-white border-0 ring-2 ring-violet-500 rounded-md p-2 mt-4" onChange={(e)=>{setUser(prev =>{return {...prev,[e.target.name]:e.target.value}})}} required name="password" value={user.password} placeholder="Password"/>
