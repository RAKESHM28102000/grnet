...
const SignUp = () => {
  ...
  return (<section className="flex w-full min-h-screen bg-cover bg-bg1">
    <div className='flex flex-col  justify-center items-center bg-cover bg-bg3 mx-auto shadow-2xl shadow-black hover:shadow-white m-4 rounded-md p-4'>
        <form className="w-[280px]  lg:w-[400px] min-h-[300px] flex flex-col gap-2 justify-start items-center">
            ...
            <input type="password"  className="w-[90%] text-violet-700 md:text-2xl max-md:text-lg mb-3 focus:ring-inset-white border-0 ring-2 ring-violet-500 rounded-xl p-2 mt-4" onChange={(e)=>{setUser(prev =>{return {...prev,[e.target.name]:e.target.value}})}} required name="password" value={user.password} placeholder="Password"/>
            <input type="password"  className="w-[90%] text-violet-700 md:text-2xl max-md:text-lg mb-3 focus:ring-inset-white border-0 ring-2 ring-violet-500 rounded-xl p-2 mt-4" onChange={(e)=>{setUser(prev =>{return {...prev,[e.target.name]:e.target.value}})}} required name="cpassword" value={user.cpassword} placeholder="Confirm Password"/>
