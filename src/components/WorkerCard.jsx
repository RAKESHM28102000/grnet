...
const WorkerCard = ({ imgURL, customerName, rating, feedback,link }) => {
  return (
    <div className='min-w-[300px] min-h-[380px] bg-gradient-to-r from-yellow-200 to-orange-400 ring-2 ring-transparent hover:ring-purple-800 shadow-2xl hover:shadow-purple-600 rounded-md px-2 py-2 shadow-black flex justify-center items-center flex-col'>
      <img
        src={imgURL}
        alt='customer'
