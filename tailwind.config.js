  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "bg-1":"url('assets/images/bg-1.jpg')",
        "bg-2":"url('assets/images/bg-2.jpg')",
        "bg-3":"url('assets/images/bg-3.jpg')",
        "bg-4":"url('assets/images/bg-4.jpg')",
        "bg-5":"url('assets/images/bg-5.jpg')",
        "bg-6":"url('assets/images/bg-6.jpg')",
        "bg-7":"url('assets/images/bg-7.jpg')",
        "bg-8":"url('assets/images/bg-8.jpg')",
        "bg-9":"url('assets/images/bg-9.jpg')",
      },
      screens: {
        "wide": "1440px"
      }
